...
namespace Cosmos
{
    ...
    public class Timer : MonoBehaviour
    {
        ...
        public float RandomRange
        {
            ...
            set
            {
                if (randomRange >= Interval) randomRange = Interval;
        ...
        public virtual void ExecuteTimerAction()
        {
            if (!RandomInterval)
                ...
                tempRoutine = Utility.Unity.StartCoroutine(EnumAction(Interval + UnityEngine.Random.Range(-RandomRange, RandomRange), () => action.Invoke()));
        }
        /// <summary>
        /// 立即停止
        /// </summary>
