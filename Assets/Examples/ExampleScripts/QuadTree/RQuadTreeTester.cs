...
public class RQuadTreeTester : MonoBehaviour
{
    RQuadTree<GameObject> quadTree;
    ...
    void Start()
    {
        ...
        quadTree = RQuadTree<GameObject>.Create(0, 0, rectRange.x, rectRange.y, new SpawnObjectBound(), maxNodeObject, maxDepth);
