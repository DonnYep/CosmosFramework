...
namespace Cosmos
{
    ...
    /// 不会被编译到实际游戏中，仅仅开发使用
    /// </summary>
    public sealed partial class CosmosEditorConst
    {
        /// <summary>
        /// EditorPrefs持久化前缀
        /// </summary>
        ...
        static string logOutputDirectory = CosmosEditorUtility.GetEditorPrefsString(LOGOUTPUT_DIRECTORY_KEY);
        static bool outputDebugLog = CosmosEditorUtility.GetEditorPrefsBool(CosmosEditorConst.OUTPUT_DEBUGLOG_KEY);
        static bool enableScriptTemplateAnnotation = CosmosEditorUtility.GetEditorPrefsBool(CosmosEditorConst.ENABLE_SCRIPTTEMPLATE_ANNOTATION_KEY);
        static bool consoleDebugLog = CosmosEditorUtility.GetEditorPrefsBool(CosmosEditorConst.CONSOLE_DEBUGLOG_KEY);
        static string annotationAuthor = CosmosEditorUtility.GetEditorPrefsString(CosmosEditorConst.ANNOTATION_AUTHOR_KEY);
