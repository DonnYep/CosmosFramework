...
namespace Cosmos.UI
{
    public abstract class UILogicBase : MonoBehaviour
    {
        ...
        [Obsolete("此方法已经弃用，请使用新方法“GetChildPanels” ")]
        ...
        protected void AddUIEventListener(string eventKey, EventHandler<GameEventArgs> handler)
        {
            Facade.AddEventListener(eventKey, handler);
        }
        protected void RemoveUIEventListener(string eventKey, EventHandler<GameEventArgs> handler)
        {
