...
namespace Cosmos.Config
{
    ...
    {
        Dictionary<string, ConfigData> cfgDataStrDict;
        public override void OnInitialization()
        {
            cfgDataStrDict = new Dictionary<string, ConfigData>();
        }
        ...
        internal bool AddConfig(string cfgKey, string configValue)
        {
            ...
            return AddConfigData(cfgKey, boolValue, intValue, floatValue, configValue);
        }
        internal bool AddConfigData(string cfgKey, bool boolValue, int intValue, float floatValue, string stringValue)
        {
            if (HasConfig(cfgKey))
                return false;
            cfgDataStrDict.Add(cfgKey, new ConfigData(boolValue, intValue, floatValue, stringValue));
            return true;
        }
        ...
        {
            return cfgDataStrDict.ContainsKey(cfgKey);
        }
        internal ConfigData? GetConfigData(string cfgKey)
        {
            ConfigData data;
            if (cfgDataStrDict.TryGetValue(cfgKey, out data))
                return data;
            return null;
        }
        /// <summary>
