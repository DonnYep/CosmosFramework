...
namespace Cosmos.Data
{
    ...
    public class DataProcessor
    {
        ...
        public void ParseJosn<T>(TextAsset ta, Action<T> callBack)
        {
        ...
        public void EditJson<T>(Action<T>callBack)
        {
        ...
        #endregion
        #region Xml
        public void ParseXml(TextAsset ta, Action<XmlDocument> callBack)
        {
