...
namespace Cosmos.Resource
{
    ...
    public class ResourceBundle : IEquatable<ResourceBundle>
    {
        ...
        string bundleKey;
        [SerializeField]
        List<BundleDependencyInfo> bundleDependencyList= new List<BundleDependencyInfo>();
        [SerializeField]
        ...
        public List<BundleDependencyInfo> BundleDependencyList
        {
            get
            {
                if (bundleDependencyList == null)
                    bundleDependencyList = new List<BundleDependencyInfo>();
                return bundleDependencyList;
            }
            set { bundleDependencyList = value; }
        }
        /// <summary>
        /// 资源对象列表。
        /// </summary>
