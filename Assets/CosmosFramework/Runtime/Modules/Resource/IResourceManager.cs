...
namespace Cosmos.Resource
{
    ...
    */
    ...
    public interface IResourceManager : IModuleManager
    {
        ...
        Coroutine LoadAssetAsync<T>(AssetInfo info, Action<T> loadDoneCallback, Action<float> progress = null) where T : UnityEngine.Object;
        /// <summary>
        /// 异步加载资源；
        /// 须使用await获取结果；
        ...
        /// <param name="progress">加载中事件</param>
        /// <returns>加载协程迭代器</returns>
        Coroutine LoadAssetWithSubAssetsAsync<T>(AssetInfo info, Action<T[]> loadDoneCallback, Action<float> progress = null) where T : UnityEngine.Object;
        /// <summary>
        /// 使用默认加载模式；
        /// 特性加载:PrefabAssetAttribute！；
        /// 加载预制体资源（异步）；
        ...
        /// <param name="instantiate">是否实例化对象</param>
        /// <returns>加载协程</returns>
        Coroutine LoadPrefabAsync(Type type, Action<GameObject> loadDoneCallback, Action<float> progress = null, bool instantiate = false);
        /// <summary>
        /// 使用默认加载模式；
        /// 特性加载:PrefabAssetAttribute！；
        /// 加载预制体资源（异步）；
        ...
        /// <param name="instantiate">是否实例化对象</param>
        /// <returns>加载协程</returns>
        Coroutine LoadPrefabAsync<T>(Action<GameObject> loadDoneCallback, Action<float> progress = null, bool instantiate = false) where T : class;
        /// <summary>
        /// 使用默认加载模式；
        /// 特性无效！；
        /// 加载预制体资源（异步）；
        ...
        /// <param name="instantiate">是否实例化对象</param>
        /// <returns>加载协程</returns>
        Coroutine LoadPrefabAsync(AssetInfo info, Action<GameObject> loadDoneCallback, Action<float> progress = null, bool instantiate = false);
        /// <summary>
        /// 使用默认加载模式；
        /// 特性无效！；
        /// 加载预制体资源（异步）；
        ...
        /// <param name="loadDoneCallback">加载完成事件</param>
        /// <returns>加载协程迭代器</returns>
        Coroutine LoadSceneAsync(SceneAssetInfo info, Action loadDoneCallback, Action<float> progress = null);
        /// <summary>
        /// 使用默认加载模式；
        /// 加载场景（异步）；
        /// 须使用await获取结果；
        ...
        /// <param name="loadDoneCallback">加载完成事件，T表示原始对象，GameObject表示实例化的对象</param>
        /// <returns>加载协程迭代器</returns>
        Coroutine LoadAssetAsync<T>(string channelName, AssetInfo info, Action<T> loadDoneCallback, Action<float> progress = null)
        ...
        /// <param name="progress">加载中事件</param>
        /// <returns>加载协程迭代器</returns>
        Coroutine LoadAssetWithSubAssetsAsync<T>(string channelName, AssetInfo info, Action<T[]> loadDoneCallback, Action<float> progress = null) where T : UnityEngine.Object;
        /// <summary>
        /// 使用自定义加载通道；
        /// 特性加载:PrefabAssetAttribute！；
        /// 加载预制体资源（异步）；
        ...
        /// <param name="instantiate">是否实例化对象</param>
        /// <returns>加载协程</returns>
        Coroutine LoadPrefabAsync(string channelName, Type type, Action<GameObject> loadDoneCallback, Action<float> progress = null, bool instantiate = false);
        /// <summary>
        /// 使用自定义加载通道；
        /// 特性加载:PrefabAssetAttribute！；
        /// 加载预制体资源（异步）；
        ...
        /// <param name="instantiate">是否实例化对象</param>
        /// <returns>加载协程</returns>
        Coroutine LoadPrefabAsync<T>(string channelName, Action<GameObject> loadDoneCallback, Action<float> progress = null, bool instantiate = false)
           where T : class;
        /// <summary>
        /// 使用自定义加载通道；
        /// 特性无效！；
        ...
        /// <param name="instantiate">是否实例化对象</param>
        /// <returns>加载协程</returns>
        Coroutine LoadPrefabAsync(string channelName, AssetInfo info, Action<GameObject> loadDoneCallback, Action<float> progress = null, bool instantiate = false);
        /// <summary>
        /// 使用自定义加载通道；
        /// 加载场景（异步）;
        /// </summary>
        ...
        /// <param name="loadDoneCallback">加载完成事件</param>
        /// <returns>加载协程迭代器</returns>
        Coroutine LoadSceneAsync(string channelName, SceneAssetInfo info, Action loadDoneCallback, Action<float> progress = null);
        /// <summary>
        /// 使用自定义加载通道；
        /// 卸载资源；
        /// </summary>
