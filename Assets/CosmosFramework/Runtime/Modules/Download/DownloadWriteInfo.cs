...
namespace Cosmos.Download
{
    ...
    /// 下载写入的信息；
    /// </summary>
    internal struct DownloadWriteInfo: IEquatable<DownloadWriteInfo>
    {
        /// <summary>
        /// 已经缓存的长度；
        /// </summary>
        ...
        public DownloadWriteInfo(long cachedLength, long writtenLength)
        {
        ...
        {
            return obj is DownloadWriteInfo && Equals((DownloadWriteInfo)obj);
        }
        public bool Equals(DownloadWriteInfo other)
        {
            bool result = false;
