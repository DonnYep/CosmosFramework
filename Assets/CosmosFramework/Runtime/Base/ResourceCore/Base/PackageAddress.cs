...
namespace Cosmos.Resource
{
    ...
    internal class PackageAddress
    {
        ...
        /// 初始化寻址文件
        /// </summary>
        /// <param name="packageName">资源包裹名</param>
        /// <param name="assets">资产信息集合</param>
        public void Init(string packageName, IEnumerable<PackageAsset> assets)
        {
            assetInfoLnkMap.Clear();
            foreach (var packageAsset in assets)
            {
                var assetInfo = new AssetInfo(packageName, packageAsset);
