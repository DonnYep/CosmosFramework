...
namespace Cosmos
{
    public static partial class Utility
    {
        ...
        where T : Component
            ...
            {
                double v = Mathf.Pow(center.x - point.x, 2) / Mathf.Pow(radiusX, 2) + Mathf.Pow(center.y - point.y, 2) / Mathf.Pow(radiusY, 2);
                return v < 1;
            }
            /// <summary>
            ///  检测点是否在XZ平面的椭圆内
            ...
            {
                double v = Mathf.Pow(center.x - point.x, 2) / Mathf.Pow(radiusX, 2) + Mathf.Pow(center.z - point.z, 2) / Mathf.Pow(radiusY, 2);
                return v < 1;
            }
            /// <summary>
            ///  检测点是否在YZ平面的椭圆内
            ...
            {
                double v = Mathf.Pow(center.y - point.y, 2) / Mathf.Pow(radiusX, 2) + Mathf.Pow(center.z - point.z, 2) / Mathf.Pow(radiusY, 2);
                return v < 1;
            }
            /// <summary>
            /// 获取一个圆内随机点
