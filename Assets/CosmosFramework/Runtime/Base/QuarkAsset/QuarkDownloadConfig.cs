...
{
    public class QuarkDownloadConfig
    {
        /// <summary>
        /// Remote资源所在的地址；
        /// </summary>
        ...
        public QuarkDownloadConfig(string url, string downloadPath, string[] fileList, bool deleteFailureFile, float timeout)
        {
        ...
        /// <param name="downloadPath"> Local资源下载后存储的地址</param>
        /// <param name="fileList">URL的相对地址文件列表</param>
        public QuarkDownloadConfig(string url, string downloadPath, string[] fileList) : this(url, downloadPath, fileList, false, 0) { }
        /// <summary>
        /// 重置配置；
        /// </summary>
        public void Reset()
